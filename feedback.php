...
<title>Online Examination/Quiz | FEEDBACK </title>
...
<p>You can directly submit your <strong>Feedback or Report</strong> by filling this form below:-</p><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="image/me.jpg" width=100 height=100 alt="Syed Nadeem"
                                class="img-rounded">
                        </div>
                        <div class="col-md-5">
                            <a href="https://www.instagram.com/ig_snag"
                                style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="Find on Facebook">Syed Nadeem Hussain</a>
                            <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9165063741
                            </h4>
                            <h4 style="font-family:'typo' ">imsnag.1@gmail.com</h4>
                            <h4 style="font-family:'typo' ">University of Pune
                            </h4>
                        </div>
                    </div>
                    </p>
