...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo"> Online Examination/Quiz</span>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="image/me.jpg" width=100 height=100 alt="Syed Nadeem Hussain"
                                class="img-rounded">
                        </div>
                        <div class="col-md-5">
                            <a href="https://www.instagram.com/ig_snag"
                                style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="">Syed Nadeem Hussain</a>
                            <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9622824214
                            </h4>
